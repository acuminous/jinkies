...
to suppress repeated errors for one hour. You can override this by creating an 
...
<table>
    ...
    <tbody>
        <tr><td>uuid</td><td>A unique id that will be used to reject duplicate events</td><td>No</td><td>floor2-123</td></tr>    
        <tr><td>sourceId</td><td>Your identifier for source of this event</td><td>Yes</td><td>Floor 2</td></tr>
        ...
        <tr><td>content</td><td>Instead of relying on a theme you can specify the content you would like to play. 
        You will have find the "resourceId" of desired content by viewing the HTML on the content page.</td><td>No</td><td>content/123</td></tr>
        <tr><td>the time this event was generated in milliseconds since epoc</td><td></td><td>No</td><td>123456789</td></tr>        
    </tbody>
</table>
